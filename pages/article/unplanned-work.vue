  ...
  <section class="section-padding">
    <div class="container thinnest-content">
      <div>
        ...
        <p>Now that you have a list of everything you need to do this week, what are your top priorities? <NuxtLink to="/article/eliminate-automate-delegate-do">Are there any items that you could remove from your plate?</NuxtLink> How many of these things can you reasonably do with the time you have available?</p>
