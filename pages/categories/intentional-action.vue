	...
	<section class="section-padding">
		<div class="container thinnest-content">
			<div>
				...
				<p>Deliberate work beats scattered busyness every time. The Intentional Action pillar guides you in choosing meaningful tasks, eliminating distractions, and finding the right tools to amplify your effort.</p>
				<p>These articles help you act with purpose and maximize your impact.</p>
				<hr>
				<div>
					<div>
						<h2>Articles</h2>
...
const category = ref("Intentional Action")
