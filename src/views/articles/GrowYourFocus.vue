  ...
  <section class="section-padding">
    <div class="container thinnest-content">
      <div>
        ...
        <p v-if="article.datePublished" class="tagline fst-italic blue mb-4">{{formatDate(article.datePublished)}}</p>
        ...
        <p>Here are some thoughts on deeping focus.</p>
        <h2>Write down the things that distract you</h2>
        <p>We choose when to eat, what to wear, and how to treat other people. We choose whether or not to answer the phone, go to the gym, and get out of bed. Giving into distraction, much like checking your phone or smoking a cigarette, is a choice.</p>
        <p>When you sit down to get some work done, take a moment to recognize the distractions around and within you. Your stomach growls. Your chair is uncomfortable. Your underwear rides up. You are upset about what your mom said to you last week. Plus, you have to pee, even though you just went.</p>
        <p>If you do not have power over these urges, then they have power over you. Write down a list of distractions when you are trying to focus to account for the things preventing you from focusing. Once you know your enemy, you can fight.</p>
        <h2>Negate and prevent distractions</h2>
